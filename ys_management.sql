...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'LAPTOP-SKTPM1781574907219517', '1574908512731', '15000');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1074 DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('1072', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-11-20 10:48:36');
INSERT INTO `sys_logininfor` VALUES ('1073', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-11-28 10:14:09');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=513 DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('510', '代码生成', '8', 'com.ruoyi.project.controller.tool.gen.GenController.genCode()', '', '1', 'admin', '银商管理中心', '/tool/gen/genCode/t_kf_detail', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-20 10:49:45');
INSERT INTO `sys_oper_log` VALUES ('511', '代码生成', '8', 'com.ruoyi.project.controller.tool.gen.GenController.genCode()', '', '1', 'admin', '银商管理中心', '/tool/gen/genCode/t_kf_detail', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-20 10:54:39');
INSERT INTO `sys_oper_log` VALUES ('512', '代码生成', '8', 'com.ruoyi.project.controller.tool.gen.GenController.genCode()', '', '1', 'admin', '银商管理中心', '/tool/gen/genCode/t_version', '127.0.0.1', '内网IP', '{}', '0', null, '2019-11-28 10:15:32');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '101', '0', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '0', '127.0.0.1', '2019-11-28 10:14:10', 'admin', '2018-03-16 11:33:00', 'ry', '2019-11-28 10:14:09', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('65934f8a-c689-419c-8df1-c08d22bf7140', 'admin', '银商管理中心', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2019-11-28 10:14:05', '2019-11-28 10:15:23', '1800000');
...
CREATE TABLE `t_version` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` tinyint(2) DEFAULT NULL COMMENT '1 iso  2 android',
  `newVersion` varchar(255) DEFAULT NULL COMMENT '最新的版本',
  `lastVersion` varchar(255) DEFAULT NULL COMMENT '最低使用版本',
  `content` varchar(512) DEFAULT NULL COMMENT '更新内容',
  `url` varchar(512) DEFAULT NULL COMMENT '更新链接',
  PRIMARY KEY (`id`)
